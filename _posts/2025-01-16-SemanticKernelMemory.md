...
The fields in this class are decorated with attributes that specify how the data should be indexed in vector store. Here is the code snippet for the DocumentRecord class:
```csharp
